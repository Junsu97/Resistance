...
public class ItemEditor : EditorWindow
{
    ...
    {
        itemList.itemList.Add(new Item(Item.ItemType.weapon, Item.ItemParts.none, -1, "default"));
        SortItemList();
        DisplayItemList();
    }
    ...
    private void DisplayItemList()
    {
        foreach(Item item in itemList.itemList)
        {
            ...
            item.manaRegeneration = float.Parse(EditorGUILayout.TextField("Mana Regen", item.manaRegeneration.ToString()));
